 ...
 */
export declare enum SpaceFeature {
 ...
 */
export declare enum UserFeature {
 ...
 */
export declare enum HistoryRotation {
    Low = "low",
    High = "high"
}
/**
 ...
 */
export declare enum SearchRange {
